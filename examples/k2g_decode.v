...
module k2g_decode (
  ...
  wire n994 = cps_xfer ? (n796 ? (is_prefix ? (n799 ? 1'b1 : (pfx_xc ? (n140 ? 1'b0 : 1'b1) : 1'b0)) : (n781 ? 1'b0 : 1'b1)) : (n946 ? 1'b0 : 1'b1)) : 1'b0;
  wire [126:0] n998 = cps_xfer ? (n796 ? (is_prefix ? (n799 ? {n807[126:112], {16'd0, cps_data}, n807[79:0]} : (pfx_xc ? (n140 ? n786 : {n865[126:112], {16'd0, cps_data}, n865[79:0]}) : n786)) : (n781 ? n786 : n783)) : (n946 ? n786 : {n976[126:71], n792[60], n976[69:0]})) : n786;
  wire n1010 = !cps_xfer;
  wire n1027 = cps_xfer & n994;
  ...
  always @* begin
    case (lb)
      6'h3F: n781 = (is_ep2 ? 1'b0 : (n669 ? 1'b0 : (n711 ? 1'b1 : n723)));
      default: n781 = 1'b0;
    endcase
  end
  ...
  always @* begin
    case (lb)
      6'h3F: n782 = (is_ep2 ? 3'd2 : (n669 ? 3'd2 : (n711 ? ((arg2 == 5'h14) ? 3'd0 : 3'd1) : (n723 ? 3'd2 : 3'd2))));
      default: n782 = 3'd2;
    endcase
  end
  ...
  always @* begin
    case (lb)
      6'h3E, 6'h3D, 6'h3C: n783 = {n228[126:50], ((lb == 6'h3E) ? 3'd0 : ((lb == 6'h3D) ? 3'd1 : 3'd2)), n228[46:0]};
      6'h1B: n783 = (((arg2[2:0] == 3'd7) | (arg2[4:3] != 2'd0)) ? {n259[126:112], {16'd0, cps_data}, n259[79:0]} : {n267[126:50], arg2[2:0], n267[46:0]});
      6'h3B: n783 = {5'd3, n222[121:0]};
      6'h3A, 6'h39, 6'h38, 6'h37: n783 = ((lb == 6'h37) ? {n310[126:112], {16'd0, cps_data}, n310[79:0]} : (pfx[41] ? {5'd6, n298[121:0]} : {n322[126:112], imm_mem, n322[79:0]}));
      6'h36: n783 = (pfx[40] ? {5'h13, n222[121:0]} : (pfx[39] ? {5'd0, n222[121:0]} : (pfx[41] ? {5'd7, n222[121:0]} : {n342[126:112], imm_mem, n342[79:0]})));
      6'h35, 6'h34, 6'h33, 6'h32: n783 = ((lb == 6'h32) ? {n360[126:112], {16'd0, cps_data}, n360[79:0]} : {n388[126:112], imm_alu, n388[79:0]});
      6'h31, 6'h30, 6'h2F: n783 = ((pfx[42] & pfx[102]) ? {n429[126:112], {16'd0, cps_data}, n429[79:0]} : {n415[126:112], imm_alu, n415[79:0]});
      6'h2E, 6'h2D, 6'h2C: n783 = (pfx[53] ? ((lb == 6'h2E) ? ((pfx[47:43] == 5'd0) ? {n454[126:112], {16'd0, cps_data}, n454[79:0]} : {5'hB, n222[121:0]}) : ((lb == 6'h2D) ? {5'hC, n222[121:0]} : {n475[126:112], {16'd0, cps_data}, n475[79:0]})) : {n485[126:66], ((lb == 6'h2E) ? 2'd0 : ((lb == 6'h2D) ? 2'd1 : 2'd2)), n485[63:0]});
      6'h2B, 6'h2A, 6'h29: n783 = {n525[126:112], {27'd0, arg2}, n525[79:0]};
      6'h28, 6'h27, 6'h26, 6'h25, 6'h24, 6'h23: n783 = ((pfx[38] | pfx[37]) ? {5'd0, n222[121:0]} : {n546[126:64], ((lb == 6'h28) ? 3'd0 : ((lb == 6'h27) ? 3'd1 : ((lb == 6'h26) ? 3'd2 : ((lb == 6'h25) ? 3'd3 : ((lb == 6'h24) ? 3'd4 : 3'd5))))), n546[60:0]});
      6'h22: n783 = ((arg2 == 5'h1A) ? {n584[126:59], 2'd1, n584[56:0]} : ((arg2 == 5'h19) ? {n584[126:59], 2'd2, n584[56:0]} : {n606[126:112], {16'd0, cps_data}, n606[79:0]}));
      6'h21: n783 = {n620[126:112], disp_bytes, n620[79:0]};
      6'h3F: n783 = (is_ep2 ? ((arg1 == 5'h19) ? {5'h11, n222[121:0]} : ((arg1 == 5'h1C) ? {5'd0, n222[121:0]} : ((arg1 == 5'h1D) ? {5'hF, n222[121:0]} : {n652[126:112], {16'd0, cps_data}, n652[79:0]}))) : (n669 ? ((pfx[42] & (arg2 == 5'h1B)) ? {n696[126:112], {16'd0, cps_data}, n696[79:0]} : {n672[126:61], ((arg2 == 5'h1C) ? 2'd0 : 2'd1), n672[58:0]}) : (n711 ? n222 : (n723 ? n222 : ((arg2 == 5'h11) ? {n737[126:112], {16'd0, cps_data}, n737[79:0]} : {n750[126:112], {16'd0, cps_data}, n750[79:0]})))));
      default: n783 = {n775[126:112], {16'd0, cps_data}, n775[79:0]};
    endcase
  end
  ...
  always @(posedge clk) begin
    if (!rst_n) begin
      ...
      pfx <= (flush_valid ? 103'd0 : (n1010 ? pfx : (n994 ? 103'd0 : (cps_xfer ? (n796 ? (is_prefix ? (n799 ? n792 : (pfx_order ? {n915[102:37], 1'b1, n915[35:0]} : n915)) : n792) : n792) : pfx))));
      state <= (flush_valid ? 2'd0 : (n1010 ? state : (n994 ? 2'd0 : (cps_xfer ? (n796 ? (is_prefix ? state : (n781 ? ((n782 == 3'd2) ? 2'd1 : 2'd2) : state)) : (n946 ? 2'd2 : 2'd0)) : state))));
      llc_dst <= (flush_valid ? 5'd0 : (n1010 ? llc_dst : (cps_xfer ? (n796 ? (is_prefix ? llc_dst : (n781 ? arg1 : llc_dst)) : llc_dst) : llc_dst)));
      llc_kind <= (flush_valid ? 3'd2 : (n1010 ? llc_kind : (cps_xfer ? (n796 ? (is_prefix ? llc_kind : (n781 ? n782 : llc_kind)) : llc_kind) : llc_kind)));
      ...
      uop_hold <= (n1027 ? {n998[126:32], (bytes_held + 32'd2)} : uop_hold);
    end
  end
