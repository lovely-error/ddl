...
module k2g_decode (
  ...
  wire n991 = cp_valid ? (n791 ? (is_prefix ? (n794 ? 1'b1 : (pfx_xc ? (n134 ? 1'b0 : 1'b1) : 1'b0)) : (n778 ? 1'b0 : 1'b1)) : (n941 ? 1'b0 : 1'b1)) : 1'b0;
  wire [126:0] n992 = cp_valid ? (n791 ? (is_prefix ? (n794 ? {n802[126:112], {16'd0, cp}, n802[79:0]} : (pfx_xc ? (n134 ? n781 : {n860[126:112], {16'd0, cp}, n860[79:0]}) : n781)) : (n778 ? n781 : n776)) : (n941 ? n781 : {n971[126:71], n787[60], n971[69:0]})) : n781;
  ...
  always @* begin
    case (lb)
      6'h3E, 6'h3D, 6'h3C: n776 = {n222[126:50], ((lb == 6'h3E) ? 3'd0 : ((lb == 6'h3D) ? 3'd1 : 3'd2)), n222[46:0]};
      6'h1B: n776 = (((arg2[2:0] == 3'd7) | (arg2[4:3] != 2'd0)) ? {n253[126:112], {16'd0, cp}, n253[79:0]} : {n261[126:50], arg2[2:0], n261[46:0]});
      6'h3B: n776 = {5'd3, n216[121:0]};
      6'h3A, 6'h39, 6'h38, 6'h37: n776 = ((lb == 6'h37) ? {n304[126:112], {16'd0, cp}, n304[79:0]} : (pfx[41] ? {5'd6, n292[121:0]} : {n316[126:112], imm_mem, n316[79:0]}));
      6'h36: n776 = (pfx[40] ? {5'h13, n216[121:0]} : (pfx[39] ? {5'd0, n216[121:0]} : (pfx[41] ? {5'd7, n216[121:0]} : {n336[126:112], imm_mem, n336[79:0]})));
      6'h35, 6'h34, 6'h33, 6'h32: n776 = ((lb == 6'h32) ? {n354[126:112], {16'd0, cp}, n354[79:0]} : {n382[126:112], imm_alu, n382[79:0]});
      6'h31, 6'h30, 6'h2F: n776 = ((pfx[42] & pfx[102]) ? {n423[126:112], {16'd0, cp}, n423[79:0]} : {n409[126:112], imm_alu, n409[79:0]});
      6'h2E, 6'h2D, 6'h2C: n776 = (pfx[53] ? ((lb == 6'h2E) ? ((pfx[47:43] == 5'd0) ? {n448[126:112], {16'd0, cp}, n448[79:0]} : {5'hB, n216[121:0]}) : ((lb == 6'h2D) ? {5'hC, n216[121:0]} : {n469[126:112], {16'd0, cp}, n469[79:0]})) : {n479[126:66], ((lb == 6'h2E) ? 2'd0 : ((lb == 6'h2D) ? 2'd1 : 2'd2)), n479[63:0]});
      6'h2B, 6'h2A, 6'h29: n776 = {n519[126:112], {27'd0, arg2}, n519[79:0]};
      6'h28, 6'h27, 6'h26, 6'h25, 6'h24, 6'h23: n776 = ((pfx[38] | pfx[37]) ? {5'd0, n216[121:0]} : {n540[126:64], ((lb == 6'h28) ? 3'd0 : ((lb == 6'h27) ? 3'd1 : ((lb == 6'h26) ? 3'd2 : ((lb == 6'h25) ? 3'd3 : ((lb == 6'h24) ? 3'd4 : 3'd5))))), n540[60:0]});
      6'h22: n776 = ((arg2 == 5'h1A) ? {n578[126:59], 2'd1, n578[56:0]} : ((arg2 == 5'h19) ? {n578[126:59], 2'd2, n578[56:0]} : {n600[126:112], {16'd0, cp}, n600[79:0]}));
      6'h21: n776 = {n614[126:112], disp_bytes, n614[79:0]};
      6'h3F: n776 = (is_ep2 ? ((arg1 == 5'h19) ? {5'h11, n216[121:0]} : ((arg1 == 5'h1C) ? {5'd0, n216[121:0]} : ((arg1 == 5'h1D) ? {5'hF, n216[121:0]} : {n646[126:112], {16'd0, cp}, n646[79:0]}))) : (n663 ? ((pfx[42] & (arg2 == 5'h1B)) ? {n690[126:112], {16'd0, cp}, n690[79:0]} : {n666[126:61], ((arg2 == 5'h1C) ? 2'd0 : 2'd1), n666[58:0]}) : (n705 ? n216 : (n717 ? n216 : ((arg2 == 5'h11) ? {n731[126:112], {16'd0, cp}, n731[79:0]} : {n744[126:112], {16'd0, cp}, n744[79:0]})))));
      default: n776 = {n770[126:112], {16'd0, cp}, n770[79:0]};
    endcase
  end
  ...
  always @* begin
    case (lb)
      6'h3F: n778 = (is_ep2 ? 1'b0 : (n663 ? 1'b0 : (n705 ? 1'b1 : (n717 ? 1'b1 : 1'b0))));
      default: n778 = 1'b0;
    endcase
  end

  assign accept = cp_valid;
  assign uop = {n992[126:32], (bytes_held + 32'd2)};
  ...
  always @(posedge clk) begin
    if (!rst_n) begin
      ...
      pfx <= (flush ? 103'd0 : (n1007 ? pfx : (n991 ? 103'd0 : (cp_valid ? (n791 ? (is_prefix ? (n794 ? n787 : (pfx_order ? {n910[102:37], 1'b1, n910[35:0]} : n910)) : n787) : n787) : pfx))));
      state <= (flush ? 2'd0 : (n1007 ? state : (n991 ? 2'd0 : (cp_valid ? (n791 ? (is_prefix ? state : (n778 ? ((n777 == 3'd2) ? 2'd1 : 2'd2) : state)) : (n941 ? 2'd2 : 2'd0)) : state))));
      llc_dst <= (flush ? 5'd0 : (n1007 ? llc_dst : (cp_valid ? (n791 ? (is_prefix ? llc_dst : (n778 ? arg1 : llc_dst)) : llc_dst) : llc_dst)));
      llc_kind <= (flush ? 3'd2 : (n1007 ? llc_kind : (cp_valid ? (n791 ? (is_prefix ? llc_kind : (n778 ? n777 : llc_kind)) : llc_kind) : llc_kind)));
