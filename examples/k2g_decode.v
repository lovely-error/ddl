...
module k2g_decode (
  ...
  wire [126:0] n766 = {5'h12, f_11[121:0]};
  wire [126:0] n769 = {n766[126:37], 5'd1, n766[31:0]};
  reg n775;
  reg [2:0] n776;
  reg [126:0] n777;
  wire [126:0] n780 = 127'd0;
  wire [102:0] n786 = {pfx[102:32], (pfx[31:0] + 32'd2)};
  wire n790 = state == 2'd0;
  wire n793 = n786[35:32] >= 4'd7;
  wire [126:0] f_12 = 127'd0;
  wire [126:0] n798 = {5'h12, f_12[121:0]};
  wire [126:0] n801 = {n798[126:37], 5'd3, n798[31:0]};
  wire [102:0] n813 = {n786[102:36], (n786[35:32] + 4'd1), n786[31:0]};
  wire [102:0] n816 = {1'b1, n813[101:0]};
  wire [102:0] n823 = {n816[102], (lb == 6'h1D), n816[100:0]};
  wire [102:0] n827 = pfx_xi ? {n823[102:101], xi_ext, n823[68:0]} : n813;
  wire [102:0] n831 = {n827[102:54], 1'b1, n827[52:0]};
  wire [102:0] n834 = {n831[102:53], arg1, n831[47:0]};
  wire [102:0] n838 = pfx_bmx ? {n834[102:48], arg2, n834[42:0]} : n827;
  wire [102:0] n841 = {n838[102:69], n134, n838[65:0]};
  wire [102:0] n844 = {n841[102:66], arg1, n841[60:0]};
  wire [126:0] f_13 = 127'd0;
  wire [126:0] n856 = {5'h12, f_13[121:0]};
  wire [126:0] n859 = {n856[126:37], 5'd2, n856[31:0]};
  wire [102:0] n869 = pfx_xc ? (n133 ? {n844[102:61], (lb == 6'h20), n844[59:0]} : n838) : n838;
  wire [102:0] n875 = {n869[102:60], 1'b1, n869[58:0]};
  wire [102:0] n879 = pfx_uto ? {n875[102:59], arg1, n875[53:0]} : n869;
  wire [102:0] n884 = pfx_flag ? {n879[102:43], 1'b1, n879[41:0]} : n879;
  wire [102:0] n889 = pfx_csp ? {n884[102:42], 1'b1, n884[40:0]} : n884;
  wire [102:0] n894 = pfx_icinvr ? {n889[102:41], 1'b1, n889[39:0]} : n889;
  wire [102:0] n899 = pfx_esp ? {n894[102:40], 1'b1, n894[38:0]} : n894;
  wire [102:0] n904 = pfx_mpd ? {n899[102:39], 1'b1, n899[37:0]} : n899;
  wire [102:0] n909 = pfx_mpi ? {n904[102:38], 1'b1, n904[36:0]} : n904;
  wire n940 = state == 2'd1;
  wire [126:0] n944 = {5'd1, n780[121:0]};
  wire [126:0] n947 = {n944[126:122], llc_dst, n944[116:0]};
  wire [126:0] n950 = {n947[126:50], llc_kind, n947[46:0]};
  wire [126:0] n961 = {n950[126:112], ((llc_kind == 3'd2) ? {llc_hi, cp} : {16'd0, cp}), n950[79:0]};
  wire [126:0] n966 = {n961[126:79], n786[68:66], n961[75:0]};
  wire [126:0] n970 = {n966[126:76], n786[65:61], n966[70:0]};
  wire n991 = cp_valid ? (n790 ? (is_prefix ? (n793 ? 1'b1 : (pfx_xc ? (n133 ? 1'b0 : 1'b1) : 1'b0)) : (n775 ? 1'b0 : 1'b1)) : (n940 ? 1'b0 : 1'b1)) : 1'b0;
  wire [126:0] n993 = cp_valid ? (n790 ? (is_prefix ? (n793 ? {n801[126:112], {16'd0, cp}, n801[79:0]} : (pfx_xc ? (n133 ? n780 : {n859[126:112], {16'd0, cp}, n859[79:0]}) : n780)) : (n775 ? n780 : n777)) : (n940 ? n780 : {n970[126:71], n786[60], n970[69:0]})) : n780;
  ...
  always @* begin
    case (lb)
      6'h3F: n775 = (is_ep2 ? 1'b0 : (n663 ? 1'b0 : (n705 ? 1'b1 : n717)));
      default: n775 = 1'b0;
    endcase
  end
  ...
  always @* begin
    case (lb)
      6'h3F: n776 = (is_ep2 ? 3'd2 : (n663 ? 3'd2 : (n705 ? ((arg2 == 5'h14) ? 3'd0 : 3'd1) : (n717 ? 3'd2 : 3'd2))));
      default: n776 = 3'd2;
    endcase
  end
  ...
  always @* begin
    case (lb)
      6'h3E, 6'h3D, 6'h3C: n777 = {n222[126:50], ((lb == 6'h3E) ? 3'd0 : ((lb == 6'h3D) ? 3'd1 : 3'd2)), n222[46:0]};
      6'h1B: n777 = (((arg2[2:0] == 3'd7) | (arg2[4:3] != 2'd0)) ? {n253[126:112], {16'd0, cp}, n253[79:0]} : {n261[126:50], arg2[2:0], n261[46:0]});
      6'h3B: n777 = {5'd3, n216[121:0]};
      6'h3A, 6'h39, 6'h38, 6'h37: n777 = ((lb == 6'h37) ? {n304[126:112], {16'd0, cp}, n304[79:0]} : (pfx[41] ? {5'd6, n292[121:0]} : {n316[126:112], imm_mem, n316[79:0]}));
      6'h36: n777 = (pfx[40] ? {5'h13, n216[121:0]} : (pfx[39] ? {5'd0, n216[121:0]} : (pfx[41] ? {5'd7, n216[121:0]} : {n336[126:112], imm_mem, n336[79:0]})));
      6'h35, 6'h34, 6'h33, 6'h32: n777 = ((lb == 6'h32) ? {n354[126:112], {16'd0, cp}, n354[79:0]} : {n382[126:112], imm_alu, n382[79:0]});
      6'h31, 6'h30, 6'h2F: n777 = ((pfx[42] & pfx[102]) ? {n423[126:112], {16'd0, cp}, n423[79:0]} : {n409[126:112], imm_alu, n409[79:0]});
      6'h2E, 6'h2D, 6'h2C: n777 = (pfx[53] ? ((lb == 6'h2E) ? ((pfx[47:43] == 5'd0) ? {n448[126:112], {16'd0, cp}, n448[79:0]} : {5'hB, n216[121:0]}) : ((lb == 6'h2D) ? {5'hC, n216[121:0]} : {n469[126:112], {16'd0, cp}, n469[79:0]})) : {n479[126:66], ((lb == 6'h2E) ? 2'd0 : ((lb == 6'h2D) ? 2'd1 : 2'd2)), n479[63:0]});
      6'h2B, 6'h2A, 6'h29: n777 = {n519[126:112], {27'd0, arg2}, n519[79:0]};
      6'h28, 6'h27, 6'h26, 6'h25, 6'h24, 6'h23: n777 = ((pfx[38] | pfx[37]) ? {5'd0, n216[121:0]} : {n540[126:64], ((lb == 6'h28) ? 3'd0 : ((lb == 6'h27) ? 3'd1 : ((lb == 6'h26) ? 3'd2 : ((lb == 6'h25) ? 3'd3 : ((lb == 6'h24) ? 3'd4 : 3'd5))))), n540[60:0]});
      6'h22: n777 = ((arg2 == 5'h1A) ? {n578[126:59], 2'd1, n578[56:0]} : ((arg2 == 5'h19) ? {n578[126:59], 2'd2, n578[56:0]} : {n600[126:112], {16'd0, cp}, n600[79:0]}));
      6'h21: n777 = {n614[126:112], disp_bytes, n614[79:0]};
      6'h3F: n777 = (is_ep2 ? ((arg1 == 5'h19) ? {5'h11, n216[121:0]} : ((arg1 == 5'h1C) ? {5'd0, n216[121:0]} : ((arg1 == 5'h1D) ? {5'hF, n216[121:0]} : {n646[126:112], {16'd0, cp}, n646[79:0]}))) : (n663 ? ((pfx[42] & (arg2 == 5'h1B)) ? {n690[126:112], {16'd0, cp}, n690[79:0]} : {n666[126:61], ((arg2 == 5'h1C) ? 2'd0 : 2'd1), n666[58:0]}) : (n705 ? n216 : (n717 ? n216 : ((arg2 == 5'h11) ? {n731[126:112], {16'd0, cp}, n731[79:0]} : {n744[126:112], {16'd0, cp}, n744[79:0]})))));
      default: n777 = {n769[126:112], {16'd0, cp}, n769[79:0]};
    endcase
  end

  assign accept = cp_valid;
  assign uop = {n993[126:32], (bytes_held + 32'd2)};
  assign uop_valid = n991;
  ...
  always @(posedge clk) begin
    if (!rst_n) begin
      ...
      pfx <= (flush ? 103'd0 : (n1006 ? pfx : (n991 ? 103'd0 : (cp_valid ? (n790 ? (is_prefix ? (n793 ? n786 : (pfx_order ? {n909[102:37], 1'b1, n909[35:0]} : n909)) : n786) : n786) : pfx))));
      state <= (flush ? 2'd0 : (n1006 ? state : (n991 ? 2'd0 : (cp_valid ? (n790 ? (is_prefix ? state : (n775 ? ((n776 == 3'd2) ? 2'd1 : 2'd2) : state)) : (n940 ? 2'd2 : 2'd0)) : state))));
      llc_dst <= (flush ? 5'd0 : (n1006 ? llc_dst : (cp_valid ? (n790 ? (is_prefix ? llc_dst : (n775 ? arg1 : llc_dst)) : llc_dst) : llc_dst)));
      llc_kind <= (flush ? 3'd2 : (n1006 ? llc_kind : (cp_valid ? (n790 ? (is_prefix ? llc_kind : (n775 ? n776 : llc_kind)) : llc_kind) : llc_kind)));
      llc_hi <= (flush ? 16'd0 : (n1006 ? llc_hi : (cp_valid ? (n790 ? llc_hi : (n940 ? cp : llc_hi)) : llc_hi)));
    end
  end
